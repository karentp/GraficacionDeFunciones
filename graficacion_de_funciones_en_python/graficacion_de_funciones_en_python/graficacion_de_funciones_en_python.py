...
if __name__ == '__main__':
    ...
    if(args.terminalinteractiva is True):
        ...
        while(True):
            yfuncion = parse_expr(input("Ingrese la función de y, a graficar: "))
            ...
            try:
                ...
                print("\nError: Las derivadas deben ser entero 0,1,2 o dejarlo vacio")
                continue
            try:
                limite_inferior = float(input("¿Cuál es el límite inferior de x?: "))
                limite_superior = float(input("¿Cuál es el límite superior de x?: "))
                assert limite_inferior < limite_superior
            except AssertionError:
                print("\n Error: El límite inferior debe ser menor al límite superior")
                continue

            try:
                paso = float(input("Ingrese el paso (diferencia entre cada x): "))
        ...
        yfuncion = leerlinea(archivo_entrada)
